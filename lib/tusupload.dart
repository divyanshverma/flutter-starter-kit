...
// // }
//
// class TusUpload extends StatelessWidget {
//   @override
...
//   Uri _fileUrl = Uri.http("user:pass@localhost:8080", "");
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
//                 child: InkWell(
//                   onTap: () async {
//                     _file = (await _getXFile((await FilePicker.platform.pickFiles())!))!;
//                     setState(() {
//                       _progress = 0;
//                       _fileUrl = Uri.http("user:pass@localhost:8080", "");
//                     });
//                   },
//                   child: Container(
